...
#' @param tol tol is passed to R's optimize function.
...
#' @param credMass the desired mass of the HDI region.
#'
#' @return A list with components: indices is a vector of indices that are in the HDI: mass is the total mass of the included indices :height is the smallest component probability mass in the HDI
#' @export
#'
#' @examples
...
#------------------------------------------------------------------------------
#' plotting properties of mcmc coda objects.
#'
#' @param codaObject codaObject
#' @param parName parName
#' @param plColors plColors
#'
#' @export
...
#' Title
#'
#' @param paramSampleVec paramSampleVec
#' @param compVal compVal
#' @param ROPE ROPE
#' @param credMass credMass
#'
#' @import coda
#'
#' @return summarizePost
#' @export
#'
